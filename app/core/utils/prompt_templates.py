...
PROFILE_USER_MANAGEMENT_SYSTEM_PROMPT = (
    ...
    "  MDO found -> Resolved. Close. Share the MDO Admin contact (Name, Email, Mobile —\n"
    "    copy the masked placeholder tokens exactly as returned, never invent, guess, or\n"
    "    paraphrase a name/email yourself); ask the user to connect with this MDO Admin and\n"
    "    request approval of their Transfer Request.\n\n"
